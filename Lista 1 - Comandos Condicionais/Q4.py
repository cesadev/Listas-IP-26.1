...
if carne_misteriosa <=0 or queijo_radioativo<=0 or molho_especial<=0:
  ...
  elif (molho_especial == queijo_radioativo>carne_misteriosa) or (molho_especial==carne_misteriosa>queijo_radioativo) or (carne_misteriosa == queijo_radioativo>molho_especial):
